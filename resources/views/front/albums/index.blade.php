    ...
    <section class="search_side" dir="rtl" >
        ...
        <div class="s130 row">
            <div class="col-md-12 title_design">
                <h2 class="text-center pt-5 p-5">جميع البومات الصور
                </h2>
            </div>

            <div class="col-md-9 search_box">
                <form action="{{route("view.album.search")}}" method="post">
                    @csrf
                ...
                <div class="col-lg-4 col-md-6 col-sm-6"  data-aos="fade-down">
                    <div class="blog__item hvr-grow">
                        ...
                        <div class="blog__item__text text-right">
                            <h5 class="text-right main_title_of_news">{{$blog->name}}</h5>

                            <h6 class="text-right main_title_of_news"> عدد الصور :  {{count($blog->photoAlbumImages)}}</h6>
                            <a href="{{route("view.album.show",$blog->id)}}" class="more_news btn btn-primary">عرض</a>
                        </div>
                    </div>
                </div>
                    @endforeach
