...
@section("title","جمعية جود | الاخبار")
@section("slider")
    ...
    <section class="search_side" dir="rtl" >
        ...
        <div class="s130 row">
            ...
            <div class="col-md-9 search_box">
                <form action="{{route("view.news.search")}}" method="post">
                    @csrf
            ...
            @isset($news)
                ...
                <div class="col-lg-4 col-md-6 col-sm-6"  data-aos="fade-down">
                    <div class="blog__item hvr-grow">
                        <div class="blog__item__pic set-bg"  data-setbg="{{asset("storage/".$blog->main_image)}}">
                        </div>
