        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12 title_design">
                    <h2 class="text-center pt-5 p-5">الدبلومات المهنية</h2>
                </div>
                        ...
                        <div class="col-lg-12">
                            <div class="card text-right">
                                ...
                                <div class="card-body text-center">
                                    <form action="{{route("view.diploma.search")}}" method="post">
                                        @csrf
                        ...
                        <div class="col-lg-4">
                            <div class="card " style="width: 100%;">
                                ...
                                <div class="card-body text-right">
                                    ...
                                    <p class="card-text">{!! Str::limit($course->short_description,150 )!!}</p>

                                    <div class="button_of_courses text-center">
                                        <a class="btn btn-primary" href="{{route("view.diploma.show",$course->id)}}" role="button">اشترك الان</a>
