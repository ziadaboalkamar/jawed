        ...
        <div class="content-header row">
            <div class="content-header-left col-md-9 col-12 mb-2">
                <div class="row breadcrumbs-top">
                    <div class="col-12">
                        <h2 class="content-header-title float-left mb-0">{{ __('الخدمات والنتجات') }}</h2>
        ...
        <div class="content-body">
            ...
            <section class="app-meals-list">
                ...
                <div class="card">
                    <div class="card-datatable table-responsive pt-0">
                        <x-alert />
                        <table class="products-list-table table">
            ...
            <div class="modal fade" id="modals-delete-bulk">
                <div class="modal-dialog">
                    <form method="post" action="{{ route('products.bulk-delete') }}" class="modal-content" style="display: inline-block;">
                        @csrf
                        @method('delete')
                        ...
                        <div class="modal-body flex-grow-1">
                            <h4>هل تريد حذف المنتجات المحددة؟</h4>
                        </div>
                        <div class="modal-footer">
