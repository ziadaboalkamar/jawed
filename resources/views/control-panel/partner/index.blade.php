    ...
    <div class="content-wrapper">
        <div class="content-header row">
            <div class="content-header-left col-md-9 col-12 mb-2">
                <div class="row breadcrumbs-top">
                    <div class="col-12">
                        <h2 class="content-header-title float-left mb-0">{{ __('شركاء النجاح') }}</h2>
        ...
        <div class="content-body">
            ...
            <section class="app-meals-list">
                ...
                <div class="card">
                    <div class="card-datatable table-responsive pt-0">
                        <x-alert />
                        <table class="partners-list-table table">
            ...
            <div class="modal fade" id="modals-create">
                <div class="modal-dialog">
                    <form class="create-new-nature modal-content pt-0"
                        action="{{ route('partners.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="modal-header mb-1">
                            <h5 class="modal-title" id="exampleModalLabel">اضافة شريك جديد</h5>
                        </div>
            ...
            <div class="modal fade" id="modals-delete-bulk">
                <div class="modal-dialog">
                    <form method="post" action="{{ route('partners.bulk-delete') }}" class="modal-content" style="display: inline-block;">
                        @csrf
                        @method('delete')
                        ...
                        <div class="modal-body flex-grow-1">
                            <h4>هل تريد حذف الشركاء المحددة؟</h4>
                        </div>
                        <div class="modal-footer">
...
@section('js')
    ...
    <!-- END: Page Vendor JS-->
    <script>
        const indexUrl = '{{ route('partners.index') }}';
    </script>
    <!-- BEGIN: Page JS-->
