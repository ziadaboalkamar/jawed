    ...
    <div class="content-wrapper">
        <div class="content-header row">
            <div class="content-header-left col-md-9 col-12 mb-2">
                <div class="row breadcrumbs-top">
                    <div class="col-12">
                        <h2 class="content-header-title float-left mb-0">{{ __('الاستشارات') }}</h2>
            ...
            <section class="app-user-list">
                ...
                <div class="card">
                    <div class="card-datatable table-responsive pt-0">
                        <x-alert />
                        <table class="consultations-list-table table">
        ...
        <div class="modal fade" id="modals-delete-bulk">
            <div class="modal-dialog">
                <form method="post" action="{{ route('consultations.bulk-delete') }}" class="modal-content" style="display: inline-block;">
                    @csrf
                    @method('delete')
...
@section('js')
    ...
    <!-- END: Page Vendor JS-->
    <script>
        const indexUrl = '{{ route('consultations.index') }}';
    </script>
