    ...
    <div class="content-wrapper">
        <div class="content-header row">
            <div class="content-header-left col-md-9 col-12 mb-2">
                <div class="row breadcrumbs-top">
                    <div class="col-12">
                        <h2 class="content-header-title float-left mb-0">{{ __('طلبات العضوية') }}</h2>
            ...
            <section class="app-user-list">
                ...
                <div class="card">
                    <div class="card-datatable table-responsive pt-0">
                        <x-alert />
                        <table class="memberships-list-table table">
                            <thead class="thead-light">
                                <tr>
                                    ...
                                    <th>{{ __('الاسم ثلاثي') }}</th>
                                    <th>{{ __('المدينة') }}</th>
                                    <th>{{ __('رقم الجوال') }}</th>
                                    <th>{{ __('نوع العضوية') }}</th>
                                    <th>{{ __('الحالة') }}</th>
                                    <th>{{ __('Action') }}</th>
                                </tr>
                            </thead>
        ...
        <div class="modal fade" id="modals-delete-bulk">
            <div class="modal-dialog">
                <form method="post" action="{{ route('memberships.bulk-delete') }}" class="modal-content" style="display: inline-block;">
                    @csrf
                    @method('delete')
...
@section('js')
    ...
    <!-- END: Page Vendor JS-->
    <script>
        const indexUrl = '{{ route('memberships.index') }}';
    </script>
